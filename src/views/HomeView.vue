<template>
  <div
    class="bg-gray-800 min-w-screen max-h-screen min-h-screen flex flex-col justify-center items-center"
  >
    <div
      class="flex flex-col bg-black lg:w-4/6 sm:w-5/6 w-full sm:my-12 sm:rounded-2xl"
    >
      <div
